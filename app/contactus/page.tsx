...
const ContactUs: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Contact Us - ChillTube</title>
        <meta name="description" content="Get in touch with ChillTube. We'd love to hear from you!" />
      </Head>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">support@chilltube.com</p>
                    <p className="text-gray-600">partnership@chilltube.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Tech District, Silicon Valley</p>
                    <p className="text-gray-600">CA 94000, USA</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">You can cancel anytime from your account settings or contact our support team.</p>
                  </div>
                </div>
              </div>
            </div>
